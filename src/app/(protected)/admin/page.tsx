...
const dashboardCards = [
  ...
  {
    title: 'Pacchetti Attrezzature',
    description: 'Gestisci i pacchetti promo (3 attrezzature a canone mensile)',
  ...
  {
    title: 'Prodotti',
    description: 'Catalogo prodotti e linee visibili nel catalogo pubblico',
    href: '/admin/products',
