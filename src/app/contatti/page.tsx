          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-secondary mb-1">Telefono</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-secondary mb-1">Indirizzo</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-secondary mb-1">Orari</h3>
                  <p className="text-gray-600">
